...
import emailServices from "../../axios/services/email.service";
  ...
  const validation = (data) => {
    for (var key in data) {
      if (!data[key].trim().length > 0) {
        setErr("Please fill out all fields before submission");
        return false;
      } else {
        setErr("");
      }
    ...
    <div className="contactPage">
      ...
      <section className="sec-1">
        ...
        <div className="right">
          ...
          <h4>
            Don't hesitate to contact us for any kind of Information or Feedback
            about AIC
          </h4>
          <br />
          <h6>
            You can call us at:{" "}
            <a href={"tel:+9203152624276"}>{"(92) 03152624276"}</a>
          </h6>
        </div>
      </section>
      <br />
