    ...
    <div>
        <div className={'footer_container'}>
            <div className={'sub_container'}>
                <img className={'logo_aic'} src={aicLogo}/><br/>
            ...
            <div className={'sub_container , contact_info'}>
                ...
                <ul>
                    <li>
                        <div><i className={'bi bi-geo-alt-fill'} style={{color:FONT_COLOR_BLUE}}/></div>
                        <a href={"https://goo.gl/maps/dgkSNHBbpeuTdRdF6"}>{footer.contactInfo.address}</a>
                    </li>
                    <li>
                        <div><i className={'bi bi-telephone-fill'} style={{color:FONT_COLOR_BLUE}}/></div>
                        {footer.contactInfo.phone}
                    </li>
                    <li>
                        <div><i className={'bi bi-envelope-fill'} style={{color:FONT_COLOR_BLUE}}/></div>
                        <a href={"mailto:info.aiclub@gmail.com?"}>{footer.contactInfo.email}</a>
                    </li>
                </ul>
            </div>
            <div className={'sub_container'}>
                <h1>Our Social Links</h1>
                <iframe name="f271174998c2124"  data-testid="fb:page Facebook Social Plugin" title="fb:page Facebook Social Plugin" frameborder="0" allowtransparency="true" allowfullscreen="true" scrolling="no" allow="encrypted-media" src="https://www.facebook.com/v2.10/plugins/page.php?app_id=&amp;channel=https%3A%2F%2Fstaticxx.facebook.com%2Fx%2Fconnect%2Fxd_arbiter%2F%3Fversion%3D46%23cb%3Df1bfe6fc56b131%26domain%3Daiclub.rcai.pk%26is_canvas%3Dfalse%26origin%3Dhttp%253A%252F%252Faiclub.rcai.pk%252Ff30291e23e08c24%26relation%3Dparent.parent&amp;hide_cover=false&amp;hide_cta=true&amp;href=https%3A%2F%2Fwww.facebook.com%2Faiclubned%2F&amp;locale=en_GB&amp;sdk=joey&amp;show_facepile=true&amp;small_header=false&amp;tabs=&amp;" style={{textAlign:'center', visibility: 'visible', display:'flex', alignSelf:'center', justifyContent:'center', position:'relative', width:'100%'}} class=""></iframe>
        ...
        <footer>Copyright © 2020. All Rights Reserved by <b style={{color:FONT_COLOR_BLUE}}>AIC CLUB -RCAI</b></footer>
    </div>
  )
}
